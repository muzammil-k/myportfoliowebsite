...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  glowColor = '20 100 60', // Adjusted to brand orange HSL: 18 100 58
  backgroundColor = '#0D0D0D', // Adjusted to brand-black
  borderRadius = 28,
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  colors = ['#FA692A', '#ffa300', '#D9D9D9'], // Adjusted to brand palette
  fillOpacity = 0.5,
}) => {
