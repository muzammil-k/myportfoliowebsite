...
export default function ProjectsPage() {
  return (
    <div className="pt-48 pb-24 px-8 md:px-24 bg-brand-black min-h-screen">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          className="mb-32"
        >
          <span className="text-brand-orange uppercase tracking-[0.6em] text-xs font-bold block mb-8">Selected Works</span>
          <h1 className="text-[12vw] md:text-[10vw] font-black text-white tracking-tighter leading-[0.8] uppercase">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24">
          {projects.map((project, i) => (
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden rounded-[40px] border border-white/5">
                <motion.div 
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                   <div className="w-24 h-24 bg-white text-brand-black rounded-full flex items-center justify-center shadow-2xl">
              ...
              <div className="mt-12 flex justify-between items-start">
                <div>
                   ...
                   <p className="text-brand-orange text-xs uppercase tracking-[0.3em] font-bold">{project.category}</p>
                </div>
                <span className="text-zinc-800 text-6xl font-black leading-none">0{project.id}</span>
              </div>
            </motion.div>
          ))}
        </div>
