...
export default function AboutPage() {
  return (
    <div className="pt-48 pb-24 px-8 md:px-24 bg-brand-black min-h-screen relative overflow-hidden">
      {/* Background Glows */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-brand-orange/10 blur-[150px] rounded-full" />
      <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-brand-orange/5 blur-[150px] rounded-full" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        >
          <span className="text-brand-orange uppercase tracking-[0.6em] text-xs font-bold block mb-8">The Alchemist</span>
          <h1 className="text-[10vw] md:text-[8vw] font-black text-white tracking-tighter leading-none mb-24 uppercase">
        ...
        <div className="grid grid-cols-12 gap-12 mt-32">
          ...
          <motion.div 
            ...
            className="col-span-12 md:col-span-6 flex flex-col justify-center space-y-12"
          >
            <p className="text-2xl md:text-3xl text-brand-white font-medium leading-relaxed">
            ...
            <div className="pt-12 grid grid-cols-2 gap-12 border-t border-white/5">
               <div>
                  <span className="text-brand-orange font-bold text-xs uppercase tracking-widest block mb-4">Focus</span>
                  <ul className="text-white text-sm space-y-2 uppercase tracking-widest">
               ...
               <div>
                  <span className="text-brand-orange font-bold text-xs uppercase tracking-widest block mb-4">Philosophy</span>
